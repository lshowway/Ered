...
class LukeEntityAwareAttentionModel(nn.Module):
    ...
    def _compute_extended_attention_mask(self, word_attention_mask: torch.LongTensor, entity_attention_mask: torch.LongTensor):
    ...
    def forward(self,
        ...
        entity_identifier_embeddings = self.entity_identifier_embeddings(entity_ids, entity_position_ids,
                                                                         entity_segment_ids)
...
class LukeForRelationClassification(nn.Module):
    def __init__(self, args, num_labels):
        super(LukeForRelationClassification, self).__init__()
