...
from modelings.modeling_bert import BertForSequenceClassification
...
def get_args():
    ...
    parser.add_argument("--KG_file", default=None, type=str, required=True)
    parser.add_argument("--TYPE_file", default=None, type=str, required=True)
    ...
    for dataset_type in ['dev']:
        for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
            ...
            for batch in tqdm(eval_dataloader, desc="Evaluating"):
                ...
                with torch.no_grad():
                    inputs = {'input_ids': batch[0], 'entity_ids': batch[1], 'entity_type_ids': batch[2],
                              'attention_mask': batch[3], 'entity_mask': batch[4],
...
def main():
    ...
    config.KG_file = args.KG_file
    config.TYPE_file = args.TYPE_file
