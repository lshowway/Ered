...
def main():
    ...
    model_weights['luke.entity_identifier_embeddings.entity_identifier_embeddings.weight'] = entity_emb
    ...
    args.model_config.entity_identifier_size = 2
    model_weights["luke.entity_identifier_embeddings.entity_identifier_embeddings.weight"] = torch.cat([entity_emb[:1], mask_emb])  # 2*256?
    # entity embedding
