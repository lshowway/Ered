...
def mix_act(x):
    ...
    # t.masked_fill_(small_mask & ~pos_mask, -1e-5)
    t.masked_filled((small_mask & pos_mask).bool(), 1e-5)
    t.masked_filled((small_mask & ~pos_mask).bool(), -1e-5)
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_all_encoded_layers=True,
                output_attention=False, position_ids=None):
        # if self.training:
...
class BertPreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, state_dict=None, cache_dir=None,
                        warmup_checkpoint=None, hub_path=None, from_tf=False, no_segment=False,
                        rel_pos_type=0, max_rel_pos=128, rel_pos_bins=32, fast_qkv=False,
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # if config.freeze_backbone:  # 不更新base model
