...
class KFormersEncoder(nn.Module):
    ...
    def forward(self, word_hidden_states, attention_mask,
        ...
        outputs = (
            word_hidden_states, k_entity_hidden_states, last_des_hidden_states, last_des_to_backbone,
...
class KFormersModel(BackboneModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, start_id=None,
        ...
        if self.pooler is None:
            ...
            return (
                original_text_output, pooled_output, entity_output, k_entity_embeddings, k_ent_output,
                mapped_k_des_output)
...
class KFormersForEntityTyping(nn.Module):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, start_id=None,
        ...
        # text representation, pooled text representation, entity identifier rep, ent/des rep
        ...
        # logits = self.typing(entity_vec + true_ent_vec + true_des_vec)
