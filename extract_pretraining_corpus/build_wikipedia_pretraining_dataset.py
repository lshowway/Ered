...
class WikipediaPretrainingDataset(object):
    ...
    def _process_page(page_title: str):
        ...
        for paragraph in _dump_db.get_paragraphs(page_title):
            ...
            # (link_start, link_end).
            paragraph_links = []
            for link in paragraph.wiki_links:  # mention?
                ...
                if link_title.startswith("Category:") and link.text.lower().startswith("category:"):
                    ...
                    if _entity_vocab.contains(link_title, _language):  # 只处理entity_vocab里边的
...
if __name__ == "__main__":
    """
            ...
            G:\D\MSRA\luke-master\resources/enwiki_latest_pages_articles
            roberta-base
            G:\D\MSRA\luke-master\resources/output_ent-vocab.jsonl
            G:\D\MSRA\luke-master\resources/wikipedia_pretrain_dataset
        """