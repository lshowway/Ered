...
# from transformers.modelings.roberta.modeling_roberta import RobertaForSequenceClassification
...
def get_args():
    ...
    # added parameters to control dataloader and knowledge for test code
    parser.add_argument("--clip_data", action='store_true')
    parser.add_argument("--KT_attn", action='store_true')
...
def main():
    ...
    assert args.max_seq_length >= args.origin_seq_length
